...
(function ($) {
	...
	$(function() {
		...
		var u = navigator.userAgent.toLowerCase(),
			...
			css_string = '' +
				'.jstree ul, .jstree li { display:block; margin:0 0 0 0; list-style-type:none; } ' +
				'.jstree li { display:block; min-height:20px; line-height:20px; white-space:nowrap; margin-left:18px; } ' +
				'.jstree-rtl li { margin-left:0; margin-right:18px; } ' +
				'.jstree > ul > li { margin-left:0px; } ' +
				'.jstree-rtl > ul > li { margin-right:0px; } ' +
				'.jstree ins { display:inline-block; text-decoration:none; width:18px; height:18px; margin:0 0 0 0; padding:0; } ' +
				'.jstree a { display:inline-block; line-height:20px; height:20px; color:rgb(77, 104, 120); font-size:13px; font-family:Open Sans; white-space:nowrap; text-decoration:none; padding:1px 2px; margin:0; } ' +
				'.jstree ul ul a { font-weight:normal;} ' +
		...
		_fn : {
			...
			select_node : function (obj, check, e) {
				...
				if(proceed && !is_selected) {
					...
					//agriya fix: added to select the newly added category
					this.data.ui.to_select = init_obj;
					this.__callback({ "obj" : obj });
				}
			},
