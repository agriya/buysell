## Mass Importer Plugin - Buysell 2.0

## Buysell Installation Instructions
	Steps to install Buysell:
	- Upload the importer script zip file into the Buysell script location of web server (Ex: /home/buysell/)
	- Unzip the file in the webserver
	- Give permissions (chmod –R 777 folder/) for the following folders & files
		- public/files
		- app/plugins/importer/lang
	- Execute the sql files in /app/plugins/importer/database/importer.sql

	That’s it! Mass Importer Plugin - Buysell 2.0 is installed successfully.

## Cron settings
	Cron setting in command prompt
	* * * * * curl --get http://yourdomain.com/importer-cron
