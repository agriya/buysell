...
@section('email_content')
	...
	<div style="line-height:18px;">
		...
		<!-- BEGIN: DEAL TIPPING NOTIFICATION TO BUYER -->
		<div style="line-height:18px; padding:10px 20px; background:#f9f9f9;">
			...
			<table width="98%" cellspacing="0" cellpadding="0" border="0">
				...
				@if(isset($view_order_link) && $view_order_link != "")
					<tr>
						<td width="150" valign="top" align="left">
						...
						<td valign="top" align="left">
							<p style="padding:0; margin:0 0 8px 0;color:#1a1a1a; font:normal 13px Arial, Helvetica, sans-serif;">
								<a style="color:#15aadb; text-decoration:none;" href="{{ $view_order_link }}" title="view sale">{{ Lang::get('deals::deals.click_here') }}</a>
							</p>
						</td>
					</tr>
				@endif
			...
			<p style="background:#d9edf7; border:1px solid #bce8f1; border-radius:4px; color:#31708f; font:normal 13px Arial, Helvetica, sans-serif; margin:10px 0; padding:10px 15px;">
				{{ Lang::get('deals::deals.for_more_details_about_this_deal') }}: <a style="color:#15aadb; text-decoration:none; font-weight:bold;" href="{{ $view_deal_link }}" title="{{ Lang::get('deals::deals.view_deal') }}">{{ Lang::get('deals::deals.view_deal') }}</a>
			</p>
		</div>
		<!-- END: DEAL TIPPING NOTIFICATION TO BUYER -->
	</div>
@stop