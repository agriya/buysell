...
@section('email_content')
	...
	<div style="line-height:18px;">
		@if(isset($admin_msg) && $admin_msg != "")
			<div style="line-height:18px; padding:10px 20px; background:#f9f9f9;">
				<p style="background:#d9edf7; border:1px solid #bce8f1; border-radius:4px; color:#31708f; font:bold 14px Arial, Helvetica, sans-serif; margin:10px 0; padding:10px 15px;">{{ $admin_msg }}</p>
			</div>
		@endif
