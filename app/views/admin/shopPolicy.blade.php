...
@endif
<!--BEGIN: SHOP DETAILS -->
{{ Form::model($shop_details, ['url' => URL::to('admin/shop/edit/'.$user_id),'method' => 'post','id' => 'shoppolicy_frm', 'class' => 'form-horizontal']) }}
	<?php
		$shop_name_msg = str_replace('VAR_MIN', Config::get('shop.shopname_min_length'), trans("shopDetails.characters_min_max_msg"));
		...
		$shop_slogan_msg = str_replace('VAR_MIN', Config::get('shop.shopslogan_min_length'), trans("shopDetails.characters_min_max_msg"));
	...
	<div class="form-group {{{ $errors->has('shop_contactinfo') ? 'error' : '' }}}">
		<div class="col-md-4 control-label">
			...
			<label>({{ trans("shopDetails.shop_contact_info_help") }})</label>
		</div>
		<div class="col-md-7">
	...
	<div class="form-group">
		<div class="col-md-offset-4 col-md-8">
			...
			<i class="fa fa-cloud-upload"></i> {{trans("common.update")}}</button>
		</div>
	</div>
{{ Form::close() }}
<!--END: SHOP DETAILS -->