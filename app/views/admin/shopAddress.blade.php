...
{{ Form::model($shop_details, ['url' => URL::to('admin/shop/edit/'.$user_id),'method' => 'post','id' => 'shopaddress_frm', 'class' => 'form-horizontal', 'onsubmit' => "retun doSubmit('shopaddress_frm', 'address_details')"]) }}
