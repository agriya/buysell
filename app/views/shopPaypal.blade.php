...
{{ Form::model($shop_paypal_details, ['url' => URL::to('shop/users/shop-details'),'method' => 'post','id' => 'shoppaypal_frm', 'class' => 'form-horizontal', 'onsubmit' => "return doSubmit('shoppaypal_frm', 'paypal_details')"]) }}
    <p class="alert alert-info"><strong>{{ trans("common.note") }}: </strong>{{ trans("shopDetails.shop_paypal_info") }}</p>
	<?php
