    ...
    <div style="line-height:18px;">
        @if(isset($invoices) && count($invoices) > 0)
            ...
            <p style="background:#f2dede; border:1px solid #ebccd1; border-radius:4px; color:#a94442; font:bold 14px Arial, Helvetica, sans-serif; margin:10px 0 20px; padding:10px 15px;">
                {{trans('mail.you_dont_have_balance')}}
            </p>
            <!-- END: ALERT BLOCK -->
            ...
            <div style="background:#fafafa; line-height:18px; padding:10px 20px;">
                ...
                <table width="98%" cellspacing="0" cellpadding="0" border="0">
                    <tr>
						...
						{{ $invoices['common_invoice_id'] }}</p></td>
                    </tr>
                    ...
                    <tr>
                        <td width="170" valign="top" align="left">
                            <p style="padding:0; margin:0 0 8px 0; color:#707070; font:normal 13px Arial, Helvetica, sans-serif;">{{trans('mail.refunded_paypal_amount')}} :</p>
                        </td>
                        <td valign="top" align="left"><p style="padding:0;margin:0 0 8px 0;color:#1a1a1a; font:normal 13px Arial, Helvetica, sans-serif;">
						{{ $invoices['currency'] }} {{ $invoices['paypal_amount'] }}</p></td>
                    </tr>
                </table>
            </div>
