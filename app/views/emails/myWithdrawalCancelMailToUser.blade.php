...
@section('email_content')
    ...
    <div style="line-height:18px;">
        ...
        <p style="background:#f2dede; border:1px solid #ebccd1; border-radius:4px; color:#a94442; font:bold 14px Arial, Helvetica, sans-serif; margin:10px 0 20px; padding:10px 15px;">
            {{trans('mail.your_withdraw_request_cancelled')}}
        </p>
        <!-- END: ALERT BLOCK -->

        <!-- BEGIN: USER WITHDRAW REQUEST DETAILS -->
        <div style="background:#fafafa; line-height:18px; padding:10px 20px;">
            <p style="margin:5px 0 20px 0; padding:0 0 5px 0; font:bold 16px Arial, Helvetica, sans-serif; color:#333; border-bottom:1px solid #eee;">{{trans('mail.withdraw_request_details')}} :</p>
