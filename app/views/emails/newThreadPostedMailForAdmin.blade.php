    ...
    <div style="line-height:18px;">
		...
		<div style="margin-bottom:35px; line-height:18px; padding:10px 20px; background:#f9f9f9;">
			...
			<table width="98%" cellspacing="0" cellpadding="0" border="0">
				...
				<tr>
					<td width="100" valign="top" align="left">
						<p style="padding:0; margin:0 0 8px 0; color:#707070; font:normal 13px Arial, Helvetica, sans-serif;">{{trans('mail.product_owner')}} :</p>
					</td>
					<td valign="top" align="left">
						<p style="padding:0;margin:0 0 8px 0;color:#1a1a1a; font:normal 13px Arial, Helvetica, sans-serif;">
						   <a href="{{$product_owner['profile_url']}}">{{$product_owner['display_name']}}</a>
						</p>
					</td>
				</tr>
		...
		@if(count($reported_threads) > 0)
			...
			<div style="line-height:18px; padding:10px 20px; background:#fafafa;">
				<p style="margin:10px 0 18px 0; padding:0 0 5px 0; font:bold 16px Arial, Helvetica, sans-serif; color:#333; border-bottom:1px solid #eee;">{{trans('mail.reported_threads')}} : </p>
				<table width="98%" cellspacing="0" cellpadding="0" border="0">
					<?php $inc = 1; ?>
