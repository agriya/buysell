...
@section('email_content')
    ...
    <!-- BEGIN: BUYER CANCELLATION DETAILS -->
    <div style="line-height:18px;">
        <div style="line-height:18px; background:#fafafa; padding:10px 20px;">
            ...
            <table width="98%" cellspacing="0" cellpadding="0" border="0">
                ...
                <tr>
                    ...
                    <td valign="top" align="left">
                        <p style="padding:0;margin:0 0 8px 0;color:#1a1a1a; font:normal 13px Arial, Helvetica, sans-serif;">{{ $order_status }}</p>
                    </td>
                </tr>
                ...
                @endif
                @if(isset($user_notes) && $user_notes != '')
                <tr>
                    <td width="100" valign="top" align="left">
                        <p style="padding:0; margin:0 0 8px 0; color:#707070; font:normal 13px Arial, Helvetica, sans-serif;">{{trans('mail.notes')}} :</p>
                    </td>
                    <td valign="top" align="left"><p style="padding:0;margin:0 0 8px 0;color:#1a1a1a; font:normal 13px Arial, Helvetica, sans-serif;">{{ $user_notes }}</p></td>
                </tr>
                @endif
            </table>
        </div>
    </div>
    <!-- END: BUYER CANCELLATION DETAILS -->
@stop
