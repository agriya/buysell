...
use OAuth\OAuth2\Service\Foursquare as BaseService;

class Foursquare extends BaseService implements ServiceInterface {
	 ...
	 *
	 * @return array
	 * @link   https://developer.foursquare.com/docs/users/users
	 */
