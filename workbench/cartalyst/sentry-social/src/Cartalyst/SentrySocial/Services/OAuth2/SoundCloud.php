...
use OAuth\OAuth2\Service\SoundCloud as BaseService;

class SoundCloud extends BaseService implements ServiceInterface {
	 ...
	 *
	 * @return array
	 * @link   http://developers.soundcloud.com/docs/api/reference#me
	 */
